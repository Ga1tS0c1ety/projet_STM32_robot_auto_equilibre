...
\begin{document}
	...
	Le PWM produit par la STM32 est un signal logique de commande. La broche \texttt{PA6} ne peut pas fournir directement le courant nécessaire à un moteur.
	...
	\begin{center}
		\fbox{\parbox{0.82\textwidth}{
				...
				$\rightarrow$ alimentation de puissance
				$\rightarrow$ moteur
		}}
	\end{center}
